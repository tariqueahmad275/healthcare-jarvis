...
def texttospeech(mytext):
    #mytext = 'Ashwin rocks when he talks'
    language = 'en'
...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        # send button
        self.send_button = Button(self.send_button_frame, text="Send", width=5, relief=GROOVE, bg='navyblue',fg = "white",
